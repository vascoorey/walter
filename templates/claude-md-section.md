...
- Blocked? Say so on the board immediately: note the blocker on the task.
...
- If a discovery genuinely blocks your task: create the Triage task, mark your task blocked, stop and ask.
